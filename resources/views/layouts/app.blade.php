...
<head>
    ...
    <title>@yield('title', 'Quản lý thư viện | Trang chủ')</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ route('dashboard') }}">Quản lý thư viện</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('readers.index') }}">Người đọc</a>
                    </li>
                    <li class="nav-item">
